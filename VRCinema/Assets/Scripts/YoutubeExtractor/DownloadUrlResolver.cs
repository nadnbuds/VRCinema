...
namespace YoutubeExtractor
{
    ...
    public static class DownloadUrlResolver
    {
        ...
        private static IEnumerable<ExtractionInfo> ExtractDownloadUrls(JsonObject json)
        {
        ...
        private static string GetStreamMap(JsonObject json)
        {
            JsonValue streamMap = json["args"]["url_encoded_fmt_stream_map"];

            string streamMapString = streamMap == JsonValue.Null ? null : streamMap.ToString().TrimStart('\"').TrimEnd('\"');
        ...
        {
            JsonValue title = json["args"]["title"];

            return title == JsonValue.Null ? String.Empty : title.ToString();
        }
        ...
        private static JsonObject LoadJson(string url)
        {
            ...
            return JsonReader.Parse(extractedJson);
        }
